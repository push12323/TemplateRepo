...
function createFirstQuestion()
{
	...
	$("#formCont").append("<audio id='audio1'><source src='assets/sounds/quiz/Cat.ogg' type='audio/ogg'/><source src='assets/sounds/quiz/Cat.wav' type='audio/wave'/><source src='assets/sounds/quiz/Cat.mp3' type='audio/mp3'/></audio><audio id='audio2'><source src='assets/sounds/quiz/Dog.ogg' type='audio/ogg'/><source src='assets/sounds/quiz/Dog.wav' type='audio/wave'/><source src='assets/sounds/quiz/Dog.mp3' type='audio/mp3'/></audio><audio id='audio3'><source src='assets/sounds/quiz/Horse.ogg' type='audio/ogg'/><source src='assets/sounds/quiz/Horse.wav' type='audio/wave'/><source src='assets/sounds/quiz/Horse.mp3' type='audio/mp3'/></audio><audio id='audio4'><source src='assets/sounds/quiz/Lion.ogg' type='audio/ogg'/><source src='assets/sounds/quiz/Lion.wav' type='audio/wave'/><source src='assets/sounds/quiz/Lion.mp3' type='audio/mp3'/></audio>");
